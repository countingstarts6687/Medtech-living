...
const tokenConceptCards = [
  ...
  { title: "Orbiva 切入点", body: "VivaBox + NTU + Web3 共同构成护城河。" },
];
...
const tokenArchitectureLayers = [
  ...
  { stage: "加工层", title: "Token Processing", items: ["NTU + Orbiva OS", "原子化处理", "多源标准化"] },
...
const modelComparisonRows = [
  { label: "数据主权", orbiva: "数据不出境", external: "需跨境上传" },
  { label: "逻辑可控", orbiva: "可解释、可审计", external: "黑盒运行" },
  { label: "IP 控制权", orbiva: "联合持有", external: "依赖外部巨头" },
];
...
const partnerCards = [
  ...
  { title: "Orbiva", desc: "提供技术平台、医疗网络资源与跨区域落地经验。", tag: "技术平台" },
...
const supplyChainFlow = [
  ...
  { title: "02 中游 · 新加坡品牌升级", subtitle: "高附加值组装", desc: "由 Orbiva 新加坡完成 AIoT 协议改造、产地认证与品牌升级。" },
  { title: "03 下游 · 国际市场", subtitle: "品牌溢价销售", desc: "通过 Orbiva 全球渠道释放 B2B / B2G / D2C 三渠道的品牌溢价。" },
];
...
const shenzhenUpdate = [
  ["公司名称", "Orbiva (Shenzhen) Intelligent Tech Co., Ltd / 欧博凡（深圳）智能科技有限公司"],
  ["成立日期", "2026-03-18"],
  ["股权结构", "Orbiva Limited 100% 子公司"],
  ["办公地点", "南山（高科技产业与人才聚集区）"],
];

const singaporeImportance = [
  { title: "法律架构基础", body: "Orbiva 在新加坡成立实体，并通过合资等方式进入印尼市场。" },
...
export default function OrbivaInteractiveBoardSite() {
            ...
            <div className="space-y-8">
              ...
              <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
                <Card className="bg-white/92">
                  <CardHeader className="space-y-4">
                    <Badge variant="outline">关于 Orbiva</Badge>
                    <CardTitle className="text-2xl text-slate-950">以 AIoT 为核心的新一代健康科技品牌</CardTitle>
                    <CardDescription className="text-sm leading-7 text-slate-600">
                      Orbiva 是 Home Control International（1747.HK）旗下全资子公司，以家庭健康监测为切入点，构建硬件、软件、数据、服务一体化的健康生态平台。
                    </CardDescription>
                  </CardHeader>
              ...
              <SectionShell dark className="px-6 py-6 sm:px-7 sm:py-7">
                <div className="space-y-7 text-white">
                  <div className="space-y-3">
                    <div className="text-xs uppercase tracking-[0.22em] text-sky-100/70">Orbiva 入场逻辑</div>
                            ...
                            <table className="w-full min-w-[520px] border-separate border-spacing-y-2 text-sm">
                              <thead>
                                <tr>
                                  ...
                                  <th className="px-3 py-2 text-left text-slate-500">Orbiva</th>
                              ...
                              <tbody>
                                {modelComparisonRows.map((row) => (
                                  <tr key={row.label}>
                                    ...
                                    <td className="bg-white px-3 py-3 text-slate-600">{row.orbiva}</td>
              ...
              {activeMarketTab === "overview" && (
                <div className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
                  ...
                  <div className="grid gap-4">
                    ...
                    <Card className="bg-white/92">
                      <CardHeader>
                        <CardTitle className="text-xl text-slate-950">Orbiva 的切入点</CardTitle>
                      </CardHeader>
                      <CardContent className="grid gap-3 px-6 pb-6 sm:grid-cols-3">
              ...
              {activeMarketTab === "indonesia" && (
                <div className="space-y-5">
                  ...
                  <div className="grid gap-5 lg:grid-cols-[1fr_1fr]">
                    <Card className="bg-white/92">
                      <CardHeader>
                        <CardTitle className="text-2xl text-slate-950">Orbiva 三步走战略</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3 px-6 pb-6">
